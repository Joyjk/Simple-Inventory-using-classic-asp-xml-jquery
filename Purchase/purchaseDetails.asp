...
<head>
    <title>Supplier Parts Details </title>
...
<body>
    ...
    <div class="container">
        <h3 style="margin-left:35%">Purchase Parts</h3>
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            type: 'GET',
            url: 'http://localhost/project/purchase/purchaseFromSupplierXML.asp',           // The file path.
            dataType: 'xml',
